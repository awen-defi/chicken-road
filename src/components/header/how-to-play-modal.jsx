export function HowToPlayModal({ ref }) {
  const closeModal = () => {
    if (ref.current) {
      ref.current.close();
    }
  ...
  return (
    <dialog ref={ref} className="how-to-play-modal">
      <div className="how-to-play-modal-header">
        <h2 className="how-to-play-modal-header-text">How to play?</h2>
        <svg
          width="16"
          height="16"
          viewBox="0 0 16 16"
          xmlns="http://www.w3.org/2000/svg"
          className="how-to-play-modal-x"
          onClick={closeModal}
        >
      ...
      <div>
        <div className="HowToPlayList heImem">
          <div className="HowToPlayListItem">
            <span>1.</span>
          ...
          <div className="HowToPlayListItem">
            <span>2.</span>
            <span>
              Choose a difficulty level in a game. The number of road lines and
              the chance to be hit car hard varies depending on the level of
              difficulty.
              <br />
              <br />
              There are 4 difficulty levels in the game: <br />
              <br />
              <ul className="HowToPlaySublist">
                <li className="HowToPlaySublistItem">
                  Easy - 3 road lines, low chance to be hit by a car
                </li>
                <li className="HowToPlaySublistItem">
                  Medium - 4 road lines, medium chance to be hit by a car
                </li>
                <li className="HowToPlaySublistItem">
                  Hard - 5 road lines, high chance to be hit by a car
                </li>
                <li className="HowToPlaySublistItem">
                  Extreme - 6 road lines, very high chance to be hit by a car
                </li>
              </ul>
            </span>
          </div>
          <div className="HowToPlayListItem">
            <span>3.</span>
            <span>Press “Play” button.</span>
          </div>
          <div className="HowToPlayListItem">
            <span>4.</span>
            <span>
              Your goal is to step as many road lines as possible without
              getting hit by a car. You can withdraw your winnings at any stage
              of the game.
            </span>
          </div>
          <div className="HowToPlayListItem">
            <span>5.</span>
            <span>
              In the menu, there is an option to enable "Space" to spin &amp;
              go, it will allow you to move forward, use the "Space" key.
            </span>
          </div>
          <div className="HowToPlayListItem">
            <span>6.</span>
            <span>Malfunction voids all pays and plays</span>
          </div>
        </div>
      </div>
    </dialog>
